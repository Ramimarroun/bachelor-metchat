        ...
        async function fetchData() {
            if (!localStorage.getItem("metchat-user")) navigate("/");
                ...
                const data = await JSON.parse(
                    localStorage.getItem("metchat-user")
                );
                setSelf(data);
            }
        }
                    ...
                    <div className="convo-list">
                        {conversations.map((conversation, i) => (
                            <div
                                ...
                                style={{
                                    backgroundColor:
                                        i === selectedChat ? "skyblue" : "",
                                }} //color chat backround (conversations - left side)
                                onClick={() =>
                                    changeCurrentChat(conversation, i)
                                }
